...
所以说，贴近标准，跟随标准（世界大厂）是最最最重要的，像小程序这样反标准的产物，站在非商业的角度来看，确实没有任何价值。扯远了。
下面来进行盘点，多利用 [https://regexr.com/](https://regexr.com/) 这个网站。
### 量词
...
### 先行断言
给定下列字符串，我只想要匹配， 后面有字母 'a' 的数字? 如何匹配？
```javascript
22222
2a
3a
